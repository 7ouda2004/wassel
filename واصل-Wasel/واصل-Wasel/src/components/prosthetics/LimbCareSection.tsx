...
const careVideos: CareVideo[] = [
  {
    ...
    desc_ar: 'شرح خطوة بخطوة لطريقة ارتداء الطرف الصناعي تحت الركبة بشكل صحيح والتأكد من فتحة الهواء',
    desc_en: 'Step-by-step guide on properly wearing a below-knee prosthesis',
    youtubeId: 'qYmJ4f9D1vE',
    category: 'wearing',
  },
  {
    id: '2',
    ...
    desc_ar: 'الطريقة الصحيحة لارتداء الطرف الصناعي فوق الركبة باستخدام اللاينر وصمام التفريغ',
    desc_en: 'The correct way to wear an above-knee prosthesis and ensure stability',
    youtubeId: '3t2e3W5k6L8',
    category: 'wearing',
  },
  {
    id: '3',
    ...
    desc_ar: 'كيفية تنظيف السوكيت واللاينر السيليكون والأجزاء المختلفة من الطرف يومياً',
    desc_en: 'How to clean the socket and various prosthetic parts daily',
    youtubeId: 'jWf0d7K8m2A',
    category: 'cleaning',
  },
  {
    id: '4',
    ...
    desc_ar: 'نصائح غسيل وتجفيف جلد الجدعة يومياً ومنع الالتهابات والتقرحات البكتيرية',
    desc_en: 'Tips for residual limb skin care to prevent infections and sores',
    youtubeId: 'V1e0n3X2M1A',
    category: 'cleaning',
  },
  {
    id: '5',
    ...
    desc_ar: 'نصائح هامة للحفاظ على مفاصل الكربون والسوكيت وإطالة العمر الافتراضي للطرف',
    desc_en: 'Essential tips for maintaining your prosthesis and extending its lifespan',
    youtubeId: 'W4p0v911pRA',
  ...
  },
  {
    ...
    desc_ar: 'العلامات التي تدل على حاجة الطرف الصناعي للصيانة أو تعديل مقاس السوكيت',
    desc_en: 'Signs that indicate your prosthesis needs maintenance or adjustment',
    youtubeId: '8mJk2m0t9m4',
    category: 'maintenance',
  },
  {
    id: '7',
    ...
    desc_ar: 'تمارين لتقوية العضلات المحيطة بالجدعة لتحسين التحكم والاتزان في الطرف الصناعي',
    desc_en: 'Exercises to strengthen muscles around the residual limb for better prosthesis control',
    youtubeId: 'hJ2k0N91p2A',
    category: 'exercises',
  },
  {
    id: '8',
    ...
    desc_ar: 'تمارين لتحسين التوازن وتدفق المشي بالطرف الصناعي بطريقة سلسة وطبيعية',
    desc_en: 'Exercises to improve balance and natural walking with the prosthesis',
    youtubeId: 'pW8e0v11m2A',
    category: 'exercises',
  },
];
