    ...
    <section id="socket-info" className="py-20 bg-gradient-to-b from-white via-slate-50/50 to-white relative overflow-hidden font-cairo">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-4">
          ...
          >
            السوكيت المقوم — <span className="text-medical-600">قلب الطرف الصناعي والواجهة التشريحية</span>
          </motion.h2>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          ...
          >
            ...
            <span>أنواع السوكيتات والبطانات ({ALL_SOCKET_TYPES.length})</span>
          </button>
          ...
          {(compareItem1 || compareItem2) && (
            ...
            >
              ...
              <span>مقارنة ({[compareItem1, compareItem2].filter(Boolean).length})</span>
            </button>
          )}
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-xl p-4 sm:p-6 rounded-3xl border border-gray-100 shadow-lg space-y-4">
              ...
              <div className="relative max-w-xl mx-auto">
                ...
                <Input
                  ...
                  placeholder="ابحث باسم السوكيت، نوع البتر، أو التكنولوجيا..."
            ...
            {filteredSockets.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="p-5 pt-0 flex items-center gap-2">
                          ...
                          <button
                            ...
                            title={isSelectedForCompare ? 'إلغاء التحديد' : 'إضافة للمقارنة'}
              ...
              <div className="text-center py-16 bg-white rounded-3xl border border-gray-100 shadow-sm text-gray-400 space-y-3">
                ...
                <p className="text-base font-bold text-gray-600">لم يتم العثور على نتائج تطابق بحثك</p>
          ...
          <div className="space-y-12 max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-medical-50 via-white to-blue-50 p-6 sm:p-8 rounded-3xl border border-medical-100 text-right space-y-3 shadow-lg relative overflow-hidden">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl sm:text-2xl font-extrabold text-gray-900">منظومة التصنيع الرقمي 3D Scanner & CAD/CAM</h3>
            ...
            <div className="space-y-6 text-right">
              ...
              <div className="space-y-3 bg-gray-50 p-4 sm:p-5 rounded-2xl border border-gray-200">
                ...
                <div className="pt-2 border-t border-gray-200">
                  <span className="text-xs font-bold text-gray-400 block mb-1">دواعي الاستخدام والتوصية الطبية:</span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                <div className="bg-gray-50 p-3 rounded-2xl border border-gray-200">
                  <span className="text-[10px] text-gray-400 font-bold block">مستوى الراحة:</span>
                ...
                <div className="bg-gray-50 p-3 rounded-2xl border border-gray-200">
                  <span className="text-[10px] text-gray-400 font-bold block">درجة الاستقرار:</span>
                ...
                <div className="bg-gray-50 p-3 rounded-2xl border border-gray-200">
                  <span className="text-[10px] text-gray-400 font-bold block">فئة الوزن:</span>
        ...
        <DialogContent className="max-w-4xl bg-white border-gray-200 text-gray-900 font-cairo max-h-[90vh] overflow-y-auto p-6 rounded-3xl">
          <DialogHeader className="text-right border-b border-gray-100 pb-4">
            ...
            <DialogDescription className="text-xs text-gray-400">
              مقارنة المزايا التشريحية ومستويات النشاط لكل نوع.
            </DialogDescription>
          </DialogHeader>
          ...
          {compareItem1 && compareItem2 ? (
            <div className="grid grid-cols-2 gap-4 text-right pt-4">
              ...
              <div className="bg-gray-50 p-5 rounded-2xl border border-gray-200 space-y-4">
                ...
                <div className="space-y-1 text-xs text-gray-500 border-t border-gray-200 pt-2">
                  ...
                  <p><strong className="text-gray-700">البطانة:</strong> {compareItem1.linerType}</p>
                  <p><strong className="text-gray-700">دواعي الاستخدام:</strong> {compareItem1.indication}</p>
                </div>
                <Button 
                  size="sm"
              ...
              <div className="bg-gray-50 p-5 rounded-2xl border border-gray-200 space-y-4">
                ...
                <div className="space-y-1 text-xs text-gray-500 border-t border-gray-200 pt-2">
                  ...
                  <p><strong className="text-gray-700">البطانة:</strong> {compareItem2.linerType}</p>
                  <p><strong className="text-gray-700">دواعي الاستخدام:</strong> {compareItem2.indication}</p>
                </div>
                <Button 
                  size="sm"
            ...
            <div className="text-center py-12 text-gray-400 space-y-3">
              <p className="text-sm font-bold">يرجى اختيار نوعين من السوكيتات للمقارنة</p>
