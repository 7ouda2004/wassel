...
const SpecialistDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
            ...
            <Tabs defaultValue="all">
              ...
              <TabsContent value="centers">
                <div className="mb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  ...
                  <Button onClick={handleAddCenter} className="medical-btn whitespace-nowrap">
                    <PlusCircle className="h-5 w-5 mr-2" />
                    إضافة مركز جديد
                  </Button>
                </div>
                ...
                <div className="mb-4 text-sm text-gray-500">
                  إجمالي المراكز: <span className="font-bold text-medical-700">{centers.length}</span> مركز
                </div>

                <div className="overflow-x-auto">
                  <Table>
                    <TableCaption>قائمة بجميع المراكز المسجلة</TableCaption>
                    <TableHeader>
                      <TableRow>
                      ...
                      {centers
                        ...
                        .map((center) => (
                          <TableRow key={center.id}>
                            ...
                            <TableCell>
                              <span className="inline-block px-2 py-1 rounded-full text-xs font-semibold bg-medical-100 text-medical-800">
                                {center.region}
                              </span>
                            </TableCell>
                        ...
                        <TableRow>
                          <TableCell colSpan={7} className="text-center h-32">
                            <div className="flex flex-col items-center justify-center text-gray-500">
                              ...
                              <span>لا يوجد مراكز مطابقة لبحثك</span>
                            </div>
                          </TableCell>
                        </TableRow>
                      )}
      ...
      <Dialog 
        open={isAddingCenter || isEditingCenter} 
        onOpenChange={(open) => {
          if (!open) {
            setIsAddingCenter(false);
            setIsEditingCenter(false);
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {isAddingCenter ? 'إضافة مركز جديد' : 'تعديل بيانات المركز'}
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-4">
              <div>
                ...
                <Input 
                  ...
                  placeholder="مثال: مركز واصل - فرع القاهرة"
                  required
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="center-image">رابط الصورة (اختياري)</Label>
                <Input 
                  id="center-image"
                  name="image"
                  value={currentCenter.image}
                  onChange={handleCenterInputChange}
                  placeholder="/images/ortho.png"
                />
              </div>
            </div>
          </div>
          ...
          <DialogFooter>
            <Button 
              variant="outline"
              onClick={() => { setIsAddingCenter(false); setIsEditingCenter(false); }}
              className="ml-2"
            >
              إلغاء
            </Button>
            <Button onClick={handleSaveCenter} className="medical-btn">
              <Save className="h-4 w-4 mr-2" />
              {isAddingCenter ? 'إضافة المركز' : 'حفظ التعديلات'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog 
        open={confirmDeleteCenter !== null} 
        onOpenChange={(open) => {
          if (!open) setConfirmDeleteCenter(null);
        }}
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              هل أنت متأكد من رغبتك في حذف هذا المركز؟
            </DialogDescription>
          </DialogHeader>
          
          <div className="py-4">
            <p>لا يمكن التراجع عن هذا الإجراء. سيتم حذف المركز نهائياً من قاعدة البيانات.</p>
          </div>
          
          <DialogFooter>
            <Button 
              variant="outline"
              onClick={() => setConfirmDeleteCenter(null)}
              className="ml-2"
            >
              إلغاء
            </Button>
